...
function MuiTable(props) {
  ...
  }, containerProps), React__default.createElement("div", Object.assign({
    className: classes.tableWrapper
  }, tableWrapperProps), React__default.createElement(Table, Object.assign({}, tableProps), includeHeaders && React__default.createElement(TableHead, Object.assign({}, headerProps), getHeaders(columns).map(function (headerRow, headerRowIndex) {
    return React__default.createElement(TableRow, Object.assign({}, resolveProp(rowProps, {
      column: null,
      rowData: null,
      ...
      return React__default.createElement(TableCell, Object.assign({}, isCellHovered && {
      ...
      }, cellProps), column.orderBy !== false && column.onHeaderClick !== false && (column.onHeaderClick || onHeaderClick) ? React__default.createElement(TableSortLabel, {
  ...
  })), React__default.createElement(TableBody, Object.assign({}, bodyProps), data && data.map(function (rowData, rowIndex) {
  ...
  React__default.createElement(TablePagination, Object.assign({
    component: "div"
  }, pagination)));
}
...
//# sourceMappingURL=mui-table.cjs.development.js.map
